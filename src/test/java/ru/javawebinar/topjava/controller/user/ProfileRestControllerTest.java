...
import ru.javawebinar.topjava.controller.AbstractControllerTest;
import ru.javawebinar.topjava.util.JsonUtil;

import static org.springframework.test.web.servlet.result.MockMvcResultHandlers.print;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.content;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.status;
import static ru.javawebinar.topjava.util.TestUtil.readFromJson;
import static ru.javawebinar.topjava.util.TestUtil.userHttpBasic;
import static ru.javawebinar.topjava.util.testData.UserTestData.*;
import static ru.javawebinar.topjava.helper.ErrorType.VALIDATION_ERROR;
import static ru.javawebinar.topjava.helper.ExceptionInfoHandler.EXCEPTION_DUPLICATE_EMAIL;
import static ru.javawebinar.topjava.controller.user.ProfileRestController.REST_URL;
